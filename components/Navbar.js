        ...
        >
          ...
          <Link href="/" className="flex items-center gap-3 group flex-shrink-0 relative z-10">
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-red-600 text-[9px] tracking-[0.35em] uppercase font-bold">GYM · NEGOMBO</span>
            </div>
          </Link>
          ...
          >
            ...
            <div className="mb-8 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-red-600 text-[9px] tracking-[0.3em] uppercase font-bold">Negombo, Sri Lanka</p>
              </div>
            </div>
